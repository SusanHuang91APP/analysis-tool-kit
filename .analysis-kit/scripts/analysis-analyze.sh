...
show_help() {
    ...
    echo "Quality Levels:"
    echo "  📝 待分析         - 0% complete"
    echo "  ⭐ 基礎框架級     - 1-20% complete"
    echo "  ⭐⭐ 核心邏輯級   - 21-40% complete"
    echo "  ⭐⭐⭐ 整合分析級 - 41-60% complete"
    echo "  ⭐⭐⭐⭐ 架構品質級 - 61-80% complete (all dependencies analyzed)"
    echo "  ⭐⭐⭐⭐⭐ 功能實作完整分析 - 81-100% complete"
    echo ""
    echo "Examples:"
